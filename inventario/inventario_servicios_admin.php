            ...
            <div class="col-md-12">
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td class='responsive-hide'><img src='" . $row['imagen'] . "' 
                        alt='imagen' class='book-image' id='imagenModal'></td>";
                        ...
                        echo "<td><button class='btn btn-primary btn-edit' data-toggle='modal' data-target='#editModal' data-userid='" . $row['id'] . "' data-username='" . $row['comentarios'] . "' data-identificador='" . $row['identificador_servicio'] . "'>Añadir comentarios</button></td>";
                    ...
                    echo "<p>No se encontraro
                    n resguardos para el servicio seleccionada.</p>";
                }
