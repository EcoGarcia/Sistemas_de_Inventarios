<?php
include('../includes/header_usuario_servicios.php');

$identificador_usuario_servicios = isset($_GET['identificador_usuario_servicios']) ? $_GET['identificador_usuario_servicios'] : null;

if ($identificador_usuario_servicios === null || !is_numeric($identificador_usuario_servicios)) {
    ...
    <div class="panel-body">
        <div class="panel-body">
            <div class="col-md-12">
                ...
                $identificador_usuario_servicios = $_GET['identificador_usuario_servicios'];
                ...
                if ($stmt) {
                    ...
                    mysqli_stmt_bind_param($stmt, "i", $identificador_usuario_servicios);
