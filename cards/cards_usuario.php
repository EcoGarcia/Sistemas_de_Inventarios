            ...
            <div class="col-md-12">
                ...
                <div class="category-container">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<a href='ver_coordinacion.php?identificador_direccion=" . $row['identificador'] . "' class='btn btn-primary'>Ver la coordinación</a>";
                        echo "<input type='hidden' name='categoria_id' value='" . $row['identificador'] . "' />";
                        echo "<a href='cards_resguardos_direccion.php?identificador_direccion=" . $row['identificador'] . "' class='btn btn-secondary'>Ver el inventario</a>";
                        echo "<input type='hidden' name='categoria_id' value='" . $row['identificador'] . "' />";
                        echo "</div>";
