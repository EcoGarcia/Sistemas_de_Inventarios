...
$identificador_coordinacion = isset($_GET['identificador_coordinacion']) ? $_GET['identificador_coordinacion'] : null;

if ($identificador_coordinacion === null || !is_numeric($identificador_coordinacion)) {
