function validarFormulario() {
    ...
    var direccion = document.getElementsByName('id_direccion')[0];
    if (direccion.value === '') {
    ...
    // Validar la selección de usuario de dirección
    var usuario = document.getElementsByName('id_usuario')[0];
    if (usuario.value === '') {
        alert('Por favor, selecciona un usuario de dirección.');
        return false;
    }
