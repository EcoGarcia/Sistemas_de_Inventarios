...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="../dashboard/dashboard_direccion.php">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                echo '<li class="nav-item active"><a class="nav-link" href="../dashboard/dashboard_direccion.php"">Inicio <span class="sr-only"></span></a></li>';
                ?>
            </ul>
